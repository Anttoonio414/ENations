...
namespace ENations.Migrations
{
    ...
    [Migration("20240221184837_AddPartyMemberToCongressMember")]
    partial class AddPartyMemberToCongressMember
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ENations.Models.CongressMember", b =>
                {
                    b.HasOne("ENations.Models.PartyMember", "PartyMember")
                        .WithOne("CongressMember")
                        .HasForeignKey("ENations.Models.CongressMember", "PartyMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ENations.Models.PoliticalParty", null)
